...
Download the `deb <https://github.com/jethornton/gcode/raw/master/gcode_0.0.3_amd64.deb>`_

Or use wget from a terminal
::

	wget https://github.com/jethornton/gcode/raw/master/gcode_0.0.3_amd64.deb
